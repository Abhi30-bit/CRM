        ...
        <>
            <div className="row mt-2">
             ...
             <Link to='' className='btn  btn-secondary btn-sm m-2'>Dashboard</Link>
                    ...
                    <Link to='coviewenq' className='btn   m-2'><i class="fa-regular fa-comment-dots"></i> Enquiries</Link>
                                        ...
                                        <div className="dropdown">
                                            ...
                                            >
                                                <li className="dropdown-item"><b>Role: <button className='btn btn-danger btn-sm fw-bold'>{localStorage.getItem('role')}</button></b></li>
                                                        <li><Link className="dropdown-item btn  " to={'myprofile'}><i class="fa-regular fa-address-card"></i>Profile</Link></li>
                                                ...
                                                <li className='border-top'><button type="submit" className="btn btn-success pe-1 ps-1  mx-2 mt-2" onClick={logout} >Logout</button>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
