    ...
    <>
      <div className="row  mt-5 mb-5 d-flex justify-content-center">
        <div className="col-sm-4 px-4 login-deg  ">
          ...
          <label for="inputPassword5" className="form-label" style={{ fontWeight: '500' }}>Password *</label>
          ...
          <span onClick={showpass}><i class="fa-regular fa-eye-slash " id='eye'></i></span>

          <small><Link to="/forgot-password" className='nav-link text-primary'>Forgot password</Link></small>
