                                    ...
                                    enq.map((e, i) => (
                                     <tr key={i} onClick={() => handleRowClick(e)} style={{ cursor: "pointer" }} >
                                            ...
                                            <td className=''>
                                                ...
                                                <a href={`https://api.whatsapp.com/send/?phone=${e.contactNumber}`} onClick={e => e.stopPropagation()} className='btn btn-outline-success d-inline'>WA</a>
                                                <a href="" className='btn btn-primary d-inline ms-1'>Copy</a>

                                                <div className="dropdown d-inline ms-1" onClick={e => e.stopPropagation()} >
                                                    <button className="btn btn-secondary " type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                                        <i className="fa-solid fa-ellipsis"></i>
                                                    </button>
                                                    <ul className="dropdown-menu">
                                                        <li><a className="dropdown-item" href="#" onClick={() => delenq(e._id)}><i className="fa fa-trash ps-3 text-danger"></i></a></li>

                     {e.status=="u" &&                                    <li>
                                                            <button type="button" className="btn btn-primary ms-3" 
                                                            data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@mdo"
                                                             onClick={() => { assignfun(e) }} >Assign</button>
